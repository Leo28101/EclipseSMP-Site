...
document.querySelectorAll('.tab').forEach(tab=>tab.onclick=()=>{
  ...
  document.querySelectorAll('.product-card').forEach(p=>p.classList.toggle('hidden',cat!=='all'&&p.dataset.cat!==cat));
});
...
['💰','Argent','5 000$ à 15 000$.'],['💎','Gemmes','100 à 300 gemmes.'],['💠','Minerais','Fer, or et diamant.'],['⬛','Obsidienne','16 à 32 blocs.'],['⚔️','Épée diamant','Épée enchantée.'],['⛏️','Pioche diamant','Efficacité IV • Solidité III.'],['🍎','Pommes dorées','8 pommes dorées.'],['🧿','Spawner basique','Poulet • Mouton • Zombie.']]},
epic:{icon:'🔥',tier:'CLÉ CLASSIQUE',title:'Clé Épique',desc:'Du loot avancé et de l’équipement Netherite.',color:'#f97316',items:[
['💰','Argent','20 000$ à 50 000$.'],['💎','Gemmes','400 à 800 gemmes.'],['💠','Diamants','16 à 32 diamants.'],['🟫','Débris antiques','8 à 16.'],['⚔️','Épée Netherite','Tranchant V.'],['⛏️','Pioche Netherite','Efficacité V • Fortune III.'],['🍎','Pommes dorées','16 pommes dorées.'],['🗿','Totem','1 totem.'],['🧿','Spawner moyen','Squelette • Araignée • Vache • Zombie Piglin.']]},
legendary:{icon:'🏆',tier:'CLÉ CLASSIQUE',title:'Clé Légendaire',desc:'Des récompenses très puissantes et rares.',color:'#eab308',items:[
['💰','Argent','75 000$ à 150 000$.'],['💎','Gemmes','1 000 à 2 000 gemmes.'],['💠','Diamants','32 à 64 diamants.'],['🟫','Débris antiques','16 à 32.'],['⚔️','Épée Netherite','Très enchantée.'],['⛏️','Pioche Netherite','Fortune IV.'],['🛡️','Armure Netherite','Protection IV.'],['🗿','Totems','2 à 4 totems.'],['🍏','Pommes enchantées','16 pommes dorées enchantées.'],['🧿','Spawner rare','Blaze • Creeper • Golem de fer.'],['💜','Bonus rare','Petite chance de gagner une Clé Améthyste.']]},
...
function openCrate(key){
  ...
  c.items.forEach((it,i)=>{
    ...
    d.innerHTML=`<div class="loot-card-top"><div class="loot-emoji">${it[0]}</div><h4>${it[1]}</h4></div><p>${c.chance?'Chance de l’obtenir à l’ouverture.':it[2]}</p>${chance}`;
    grid.appendChild(d);
  });
...
document.querySelectorAll('.view-btn').forEach(b=>b.onclick=()=>openCrate(b.dataset.key));
